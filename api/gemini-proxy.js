...
module.exports = async function handler(req, res) {
  ...
  try {
    // We default to gemini-3.6-flash which is stable and ideal for this task.
    // Allow custom model parameter in request query if desired, default to gemini-3.6-flash.
